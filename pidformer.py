...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0., layerth = None, alpha = None):
        super().__init__()
    ...
    def forward(self, x, v0 = None, accum_res_prev = None, u_k2 = None, u_k1 = None):
        ...
        if self.layerth == 0:
            # return x, x.reshape(B, N,self.num_heads, C//self.num_heads).permute(0, 2, 1, 3), accum_res_prev, u_k1, u_k2
...
class Block(nn.Module):
    ...
    def forward(self, x, v0 = None, accum_res_prev = None, u_k1 = None, u_k2 = None):
        ...
        if self.layerth == 0:
            ...
            x_, accum_res_prev, u_k1, u_k2 = self.attn(self.norm1(x), v0 = v0, accum_res_prev = accum_res_prev, u_k1 = u_k1, u_k2 = u_k2)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', alpha = None):
        """
        Args:
        ...
        self.blocks = nn.ModuleList([
            Block(
                ...
                attn_drop=attn_drop_rate, drop_path=dpr[i], norm_layer=norm_layer, act_layer=act_layer, layerth = i, alpha= alpha)
    ...
    def forward_features(self, x):
        ...
        for i in range(1, len(self.blocks)):
            x, accum_res_prev, u_k1, u_k2= self.blocks[i](x, v0 = v0, accum_res_prev = accum_res_prev, u_k1 = u_k1, u_k2 = u_k2)
        x = self.norm(x)
        if self.dist_token is None:
